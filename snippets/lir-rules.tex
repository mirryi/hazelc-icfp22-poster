...
\begin{mathpar}
  ...
  \judgment{
    \hasTypeCtx{\Gamma}{\Delta}{\SortCompVar}{\SortTypVar} \\
    \hasTypeCtx{\extendCtx{\Gamma}{x}{\SortTypVar}}{\Delta}{\SortCompVar'}{\SortTypVar'}
  }{
    \hasTypeCtx{\Gamma}{\Delta}{\ELet{x}{\SortCompVar} \EInn \SortCompVar'}{\SortTypVar'}
  }{TALet} \\

  \judgment{
    \hasTypeCtx{\Gamma}{\Delta}{\SortImmVar}{\TMk{\SortTypConVar}{\CII}} \\\\
    \hasTypeCtx{\extendCtx{\Gamma}{x}{\TMk{\SortTypConVar}{\CNC}}}{\Delta}{\SortCompVar}{\SortTypVar} \\
    \hasTypeCtx{\extendCtx{\Gamma}{x'}{\TMk{\SortTypConVar}{\CNI}}}{\Delta}{\SortCompVar'}{\SortTypVar}
  }{
    \hasTypeCtx{\Gamma}{\Delta}{
      \EBranchWith{\SortImmVar}
        \EBranchBr{x}{\SortCompVar}
        ~\EBranchBr{x'}{\SortCompVar'}
      }{\SortTypVar}
  }{TABranch}
\end{mathpar}
